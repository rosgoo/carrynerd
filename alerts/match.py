#!/usr/bin/env python3
"""
bagdex alert matcher — the cron that isn't a cron.
...
SITE_URL = os.environ.get("SITE_URL", "https://bagdex.com").rstrip("/")
ALERT_FROM = os.environ.get("ALERT_FROM", "bagdex <alerts@bagdex.com>")
...
<div style="font-family:ui-monospace,SFMono-Regular,Menlo,monospace;max-width:520px;color:#16181a">
  <p style="letter-spacing:.1em;text-transform:uppercase;font-size:11px;color:#8e938f">bagdex price drop</p>
